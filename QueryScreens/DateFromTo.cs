...
{
    public class DateFromTo : FTLQueryScreen
    {
        ...
        {
            return $"DateFromValue={DateFromValue}&ToValue={DateToValue}";
        }
...
<label>To:</label><input name='DateToValue' class='form-control dateBox' type='text' />";
